  ...
  return (
    <>
      <div className="space-y-6">
        ...
        {/* Botón de acción (versión normal, dentro del flujo) - detectado por el observer */}
      ...
      {/* CTA sticky - solo mobile, y solo cuando el botón principal NO está visible */}
      <div
        className={`md:hidden fixed bottom-0 inset-x-0 z-50 bg-zinc-950/95 backdrop-blur-sm border-t border-zinc-800 px-4 py-3 transition-transform duration-300 ${
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex-shrink-0">
            ...
            {hasPromo && hasStock && (
              <p className="text-xs text-zinc-500 font-mono line-through leading-tight">
          ...
          {hasStock ? (
            <button
              onClick={handleAddToCart}
              className={`flex-1 py-3 rounded-full font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 active:scale-98 ${
                added
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 py-3 rounded-full font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 active:scale-98 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400"
            >
              WhatsApp
            </a>
          )}
