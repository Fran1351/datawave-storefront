...
export default function Toast({ message, onClose }: ToastProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-zinc-900 border border-cyan-500/40 text-white px-5 py-4 rounded-2xl shadow-[0_0_25px_rgba(6,182,212,0.25)] backdrop-blur-md">
